export const CLIENT_ID = "5fb2330547334086a6d2b26913734e44";
export const REDIRECT_URI = "http://127.0.0.1:5500";
export const SCOPES = "user-read-email user-read-private user-top-read";
...
export const ALBUM_SOURCE_TRACK_LIMIT = 50;
